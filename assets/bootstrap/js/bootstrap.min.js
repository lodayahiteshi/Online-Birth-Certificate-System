...
!(function(t, e) {
    ...
    class et extends H {
        ...
        show() {
            ...
            if (this._config.parent) {
                ...
                e = U.find(".collapse.show, .collapse.collapsing", this._config.parent).filter(
                    (e) => !t.includes(e)
                );
            }
    ...
    function mt(t) {
        return (
            "undefined" != typeof ShadowRoot && (t instanceof ut(t).ShadowRoot || t instanceof ShadowRoot)
        );
    }
    var gt = {
        name: "applyStyles",
                ...
                (function(t) {
                    ...
                    return (
                        ...
                        ((s = n.width),
                            ...
                            ((r = n.offsetLeft), (a = n.offsetTop))), { width: s, height: o, x: r + Kt(t), y: a }
                    );
                })(t)
            ) :
            pt(e) ?
    ...
    function le(t, e, i) {
        ...
        return (
            ...
            (("body" !== dt(e) || Xt(a)) &&
                (c =
                    (n = e) !== ut(n) && pt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } :
                    Vt(n)),
    ...
    class Oe extends H {
        ...
        show() {
            ...
            this._inNavbar ? F.setDataAttribute(this._menu, "popper", "none") : this._createPopper(e),
                ...
                !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((t) => P.on(t, "mouseover", h)),
                this._element.focus(),
    ...
    class xe {
        ...
        _getConfig(t) {
            return (
                ((t = {...ke, ...("object" == typeof t ? t : {}) }).rootElement = o(t.rootElement)),
                r("backdrop", t, Le),
                t
            );
        }
    ...
    class je extends H {
        ...
        _getConfig(t) {
            return (
                (t = {...Ie, ...F.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }),
                r("modal", t, Pe),
                t
            );
        }
    ...
    class Be extends H {
        ...
        _getConfig(t) {
            return (
                (t = {...Me, ...F.getDataAttributes(this._element), ...("object" == typeof t ? t : {}) }),
                r("offcanvas", t, He),
                t
            );
        }
