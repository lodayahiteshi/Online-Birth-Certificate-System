...
<center>
    <h2>Payment for Lost Birth Certificate</h2><br><br>
    <form>
        <label for="name">Name</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="textbox" name="name" id="name" placeholder="Enter your name" required="" /><br /><br /><br>
        <label for="amt">Amount</label>&nbsp;&nbsp;&nbsp;
        <input type="textbox" name="amt" id="amt" placeholder="Enter amt" value="200" readonly /><br /><br /><br><br>
        ...
        jQuery.ajax({
            ...
            success: function(result) {
                var options = {
                    ...
                    "description": "Lost Certificate Transaction",
                    ...
                    "handler": function(response) {
                        jQuery.ajax({
                            ...
                            success: function(result) {
                                window.location.href = "thank_you_1.php";
                            }
                        });
                    }
                };
